...
class FeatureBasedSelection(BaseSelection):
	...
	matrix of similarities, they can easily scale to report sets with millions of
	examples. 
	
	.. note:: 
		All values in your report must be positive for this selection to work.
	...
	the size of the full report set, like it is for graph-based functions.
